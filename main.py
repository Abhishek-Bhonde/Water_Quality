...
def Headder():
    ...
    [data-testid="stAppViewContainer"] > .main {{
        background-image: url("https://raw.githubusercontent.com/Abhishek-Bhonde/Water-Quality/main/img/Header.png");
        background-size: 100%;
...
def Water_Checker():
    ## Water Checker(title)
    st.image('https://raw.githubusercontent.com/Abhishek-Bhonde/Water-Quality/main/img/Frame%201.png')
...
<div class="footer">
<img src ='https://raw.githubusercontent.com/Abhishek-Bhonde/Water-Quality/main/img/Frame%202.png' style="vertical-align:centre"></img>
</div>
"""
